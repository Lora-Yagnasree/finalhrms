        ...
        for ticket in tl_tickets:
            ...
            if ticket.escalate_to_hr and ticket.escalate_to_hr.email:
                send_mail(
                    ...
                    message=(
                        f"Dear {ticket.escalate_to_hr.first_name},\n\n"
                        f"A new ticket has been escalated to you for review.\n\n"
                        f"Ticket Details:\n"
                        f"- Employee: {ticket.employee}\n"
                        f"- Issue Type: {issue_display}\n"
                        f"- Description: {ticket.description}\n\n"
                        f"Please review the issue at your earliest convenience.\n\n"
                        f"Best regards,\n"
                        f"HRMS Team"
                    ),
            ...
            if ticket.manager and ticket.manager.email:
                send_mail(
                    ...
                    message=(
                        ...
                        f"The following ticket requires your attention:\n\n"
                        f"Ticket ID: {ticket.id}\n"
                        f"Raised By: {ticket.employee}\n"
                        f"Issue Type: {issue_display}\n"
                        f"Description: {ticket.description}\n\n"
                        f"Please review and take the necessary action promptly.\n\n"
                        f"Best regards,\n"
                        f"HRMS Team"
