...
class Employee(models.Model):
    ...
    uan_number = EncryptedCharField(max_length=512, unique=True, verbose_name="UAN Number")
    pan_number = EncryptedCharField(max_length=512, unique=True, verbose_name="PAN Number")
    ...
    bank_account_number = EncryptedCharField(max_length=512, null=True, blank=True, verbose_name="Bank Account Number")
    bank_name = models.CharField(max_length=100, null=True, blank=True)
    ifsc_code = models.CharField(max_length=11, null=True, blank=True)
    aadhar_number = EncryptedCharField(max_length=512, unique=True, null=True, blank=True, verbose_name="Aadhar Number")
